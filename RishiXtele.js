...
case 'runtime':{
    XeonBotInc.deleteMessage().catch(() => {});
      reply(`➲ 𝚁𝙸𝚂𝙷𝙸 𝙱𝚄𝙶 𝙱𝙾𝚃 𝙾𝙽𝙻𝙸𝙽𝙴 ${runtime(process.uptime())}`)
    }
  break
  /*case 'menu': case 'back!':
...
▶︎ 𝑩𝑶𝑻 𝑵𝑨𝑴𝑬: ${BOT_NAME}
▶︎ 𝑶𝑾𝑵𝑬𝑹: ${OWNER_NAME}
▶︎ 𝑹𝑨𝑴 : ${formattedUsedMem} / ${formattedTotalMem}
▶︎ 𝑫𝑨𝑻𝑬 : ${new Date().toLocaleString()}
༆❍⊶⊷⊶⊷✶💦✶⊶⊷⊶⊷❍༆
...
➲╤╤╤╤╤╤╤╤✮´-`
XeonBotInc.telegram.sendVideo(XeonBotInc.chat.id, global.pp2, {
    caption: xeontext,
    parse_mode: "Markdown",
    reply_markup: JSON.stringify({
      inline_keyboard: [
        [
          { text: "『☠ 𝐎𝐖𝐍𝐄R ☠』", url: "https://t.me/ANUWH4YOU" },
          { text: "『💌 𝐂𝐇𝐀𝐍𝐍𝐄L 💌』", url: "https://t.me/ANUWH4YOU" }
        ]
      ]
    })
    });
break*/
/*const videoPath = __dirname + '/XeonMedia/Cheems-bot.mp4';
XeonBotInc.telegram.sendVideo(XeonBotInc.chat.id, videoPath, {
  caption: xeontext,
  parse_mode: "Markdown",
  reply_markup: JSON.stringify({
    inline_keyboard: [
      [
        { text: "『☠ 𝐎𝐖𝐍𝐄R ☠』", url: "https:                   
        { text: "//t.me/ANUWH4YOU" },
        { text: "『💌 𝐂𝐇𝐀𝐍𝐍𝐄L 💌』", url: "https://t.me/ANUWH4YOU" }
      ]
    ]
